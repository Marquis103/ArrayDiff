...
public extension Array {
	...
	public func diff(_ other: Array<Element>, elementsAreEqual: ((Element, Element) -> Bool)) -> ArrayDiff {
		...
		let commonObjects = self[commonIndexes as IndexSet]
		...
		return ArrayDiff(commonIndexes: commonIndexes as IndexSet, removedIndexes: removedIndexes as IndexSet, insertedIndexes: addedIndexes as IndexSet)
	}
}
